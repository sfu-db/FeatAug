...
class SQLGen(object):
    ...
    def optimize(
        ...
        self.query_template.predicate_attrs = self.query_template.all_predicate_attrs
        self.query_template.predicate_attrs_type = self.query_template.all_predicate_attrs_type
        ...
        total_feature_num = outer_budget * query_template_num
        while total_feature_num > 0:
            ...
            print(f"Top {total_feature_num} validation score: {self.optimal_query_list[-1]['value']}!")
            test_score = self._evaluate_test_data()
            print(f"Top {total_feature_num} test score: {test_score}!")
