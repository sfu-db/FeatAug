...
def load_data(SAMPLE_ROW_NUM: int = 10000):
    path = "../exp_data/Tmall/"
    ...
    random.seed(42)
    sampled_users = random.sample(train_data['user_id'].unique().tolist(), SAMPLE_ROW_NUM)
    print(sampled_users)
...
if __name__ == "__main__":
    ...
    train_data, train_labels, valid_data, valid_labels, test_data, test_labels, user_log = load_data(SAMPLE_ROW_NUM = sampled_row_num)
