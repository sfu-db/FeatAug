...
def load_data(SAMPLE_ROW_NUM_RELEVANT_TABLE: int = 880000):
    ...
    sampled_histocial_transactions = sampled_histocial_transactions.sample(n=SAMPLE_ROW_NUM_RELEVANT_TABLE)
    ...
    print(f"# of sampled TRAINING DATA:{len(X_train)}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-rr', '--sampled_row_num', type=int, default=880000, help = "ML model",required = False)
